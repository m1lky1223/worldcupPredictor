...
@/Users/rony/dev/worldcupPredictor/.opencode/gsd-core/references/thinking-models-research.md
...
```bash
node "/Users/rony/dev/worldcupPredictor/.opencode/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
