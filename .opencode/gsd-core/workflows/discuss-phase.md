...
<required_reading>
@/Users/rony/dev/worldcupPredictor/.opencode/gsd-core/references/domain-probes.md
@/Users/rony/dev/worldcupPredictor/.opencode/gsd-core/references/gate-prompts.md
@/Users/rony/dev/worldcupPredictor/.opencode/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "/Users/rony/dev/worldcupPredictor/.opencode/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@/Users/rony/dev/worldcupPredictor/.opencode/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
