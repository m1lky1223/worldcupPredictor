...
<template>
@/Users/rony/dev/worldcupPredictor/.opencode/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/rony/dev/worldcupPredictor/.opencode/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/rony/dev/worldcupPredictor/.opencode/gsd-core/workflows/transition.md`.
...
- Follow @/Users/rony/dev/worldcupPredictor/.opencode/gsd-core/workflows/diagnose-issues.md
