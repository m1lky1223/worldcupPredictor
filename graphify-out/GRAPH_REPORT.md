...
Cohesion: 0.07
Nodes (27): 1. Bounded Contexts, 1. Modern.js Web App (`apps/web`), 1. SOLID Design Mappings, 2. Apollo GraphQL API (`apps/api`), 2. Domain Objects (Aggregates, Entities, and Value Objects), 2. DRY & KISS, 3. Background Worker (`apps/worker`), 3. Command Query Responsibility Segregation (CQRS) (+19 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (35): Access Control, Agent Interface, API, Authentication and Authorization, Context, Data Ingestion, Database, Docker and Environment Configuration (+27 more)
...
Cohesion: 0.07
Nodes (26): Agent Context Profiles, AGENTS.md — 2026 World Cup Predictor, API & Data Fetching, API & GraphQL Best Practices, Architectural Principles, Architecture, Beads Issue Tracker, Coding Conventions (+18 more)
...
Cohesion: 0.18
Nodes (10): dialect, enums, id, _meta, columns, schemas, tables, prevId (+2 more)
...
Cohesion: 0.06
Nodes (31): description, devDependencies, @cucumber/cucumber, drizzle-orm, eslint, @graphql-codegen/cli, @graphql-codegen/typescript, @graphql-codegen/typescript-resolvers (+23 more)
...
Cohesion: 0.12
Nodes (16): dependencies, bullmq, dotenv, ioredis, @worldcup/data-providers, @worldcup/domain, @worldcup/prediction-engine, main (+8 more)
...
Cohesion: 0.10
Nodes (20): 1. Install Dependencies, 1. Spin up Services, 2026 FIFA World Cup Predictor, 2. Development Commands, 2. Set Up Environment Variables, 3. Spin Up Local Databases, 4. Apply Migrations and Seed Data, 5. Run the Application Stack (+12 more)

### Community 38 - "Community 38"
Cohesion: 0.25
Nodes (7): compilerOptions, module, moduleResolution, noEmit, target, files, references

### Community 39 - "Community 39"
Cohesion: 0.25
Nodes (7): compilerOptions, jsx, outDir, rootDir, extends, include, references
...
Cohesion: 0.18
Nodes (11): name, position, name, notNull, primaryKey, type, columns, name (+3 more)
...
Cohesion: 0.05
Nodes (41): Alternatives Considered, Anti-Patterns to Avoid, Applicable ASVS Categories, Architectural Responsibility Map, Architecture Patterns, Assumptions Log, BDD Cucumber script run using tsx loader, Code Examples (+33 more)
...
Cohesion: 0.06
Nodes (35): Check 8a — Automated Verify Presence, Check 8b — Feedback Latency Assessment, Check 8c — Sampling Continuity, Check 8d — Wave 0 Completeness, Check 8e — VALIDATION.md Existence (Gate), Dimension 10: AGENTS.md Compliance, Dimension 11: Research Resolution (#1602), Dimension 12: Pattern Compliance (#1861) (+27 more)
...
Cohesion: 0.06
Nodes (33): 100% Requirement Coverage, 1. Summary Checklist (under `## Phases`), 2. Detail Sections (under `## Phase Details`), 3. Progress Table, Anti-Enterprise, Coverage is Non-Negotiable, Deriving Phase Success Criteria, Deriving Phases from Requirements (+25 more)
...
Cohesion: 0.06
Nodes (33): workflow, ai_integration_phase, auto_advance, _auto_chain_active, auto_prune_state, code_review, code_review_command, code_review_depth (+25 more)
...
Cohesion: 0.07
Nodes (27): Anti-Patterns, apis.json -- API Surfaces, arch.md -- Architecture Summary, Completion Protocol, Config Gate, Context Quality Tiers, Core Principle, deps.json -- Dependency Chains (+19 more)
...
Cohesion: 0.10
Nodes (20): agent_skills, brave_search, claude_md_path, _comment, commit_docs, context_window, exa_search, firecrawl (+12 more)

### Community 94 - "Community 94"
Cohesion: 0.10
Nodes (21): haiku, opus, sonnet, haiku, opus, sonnet, haiku, opus (+13 more)
...
Cohesion: 0.11
Nodes (18): Canonical References, Database Migrations, Database Seeding, Deferred Ideas, Established Patterns, Existing Code Insights, GraphQL Models, Host & Environment Resolution (+10 more)
...
Cohesion: 0.11
Nodes (18): workflow, auto_advance, code_review_command, cross_ai_command, cross_ai_execution, cross_ai_timeout, discuss_mode, nyquist_validation (+10 more)
...
Cohesion: 0.12
Nodes (16): `apps/mcp/package.json` (config, config), `apps/mcp/src/index.ts` (service, request-response), `apps/mcp/tsconfig.json` (config, config), `codegen.ts` (config, config), Configuration Inheritance, Dependency Injection via Environment, `docker-compose.yml` (config, config), File Classification (+8 more)
...
Cohesion: 0.12
Nodes (15): antigravity, augment, claude, cline, codebuddy, codex, copilot, cursor (+7 more)
...
Cohesion: 0.15
Nodes (12): dependencies, @modelcontextprotocol/sdk, @worldcup/domain, main, name, private, scripts, build (+4 more)

### Community 125 - "Community 125"
Cohesion: 0.15
Nodes (12): AGENTS.md Template, Architecture Section, Conventions Section, Fallback Behavior, Marker Format, Profile Section (Placeholder Only), Project Section, Section Ordering (+4 more)
...
Cohesion: 0.17
Nodes (11): agent_skills, claude_md_path, git, create_tag, granularity, hooks, context_warnings, mode (+3 more)
...
Cohesion: 0.17
Nodes (11): 1.5. Config Gate (feature disabled by default), 1. Parse and Normalize Arguments, 2. Initialize, 3. Validate Phase + Pre-flight Gate, 4. Initial Planning (if no plans exist), 5. Convergence Loop, 5a. Review (Spawn Agent), 5b. Extract HIGH Count from CYCLE_SUMMARY Contract (+3 more)
...
Cohesion: 0.22
Nodes (11): effort, agent_overrides, default, routing_tier_defaults, fast_mode, agent_overrides, enabled, routing_tier_defaults (+3 more)

### Community 153 - "Community 153"
Cohesion: 0.18
Nodes (10): areas_completed, areas_remaining, canonical_refs, decisions, Area 1, Area 2, deferred_ideas, phase (+2 more)
...
Cohesion: 0.18
Nodes (10): Auto-Group by Design Area, Copy Source Files, Curate Sketches One-at-a-Time, Determine Output Skill Name, Gather Sketch Inventory, ▶ Next Up, Synthesize Reference Files, Update Project AGENTS.md (+2 more)

### Community 158 - "Community 158"
Cohesion: 0.20
Nodes (9): Accomplishments, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance, Phase 01-monorepo-local-infrastructure: Plan 02 Summary (+1 more)

### Community 159 - "Community 159"
Cohesion: 0.20
Nodes (9): Database Migrations, Database Seeding, Deferred Ideas, GraphQL Models, Host & Environment Resolution, Monorepo Workspaces, Phase 1: Monorepo & Local Infrastructure - Discussion Log, Testing Strategy (+1 more)
...
Cohesion: 0.22
Nodes (9): gates, confirm_breakdown, confirm_phases, confirm_plan, confirm_project, confirm_roadmap, confirm_transition, execute_next_plan (+1 more)
...
Cohesion: 0.06
Nodes (31): 1. Requirements Map & Decisions, 1. Unit Tests (Vitest), 1. Venues (`venues`), 2. Database Schema Design (F2), 2. Integration Tests (Vitest + DB), 2. Match Events (`match_events`), 3. BDD Tests (Cucumber), 3. Data Ingestion & Provider Adapters (F3) (+23 more)
...
Cohesion: 0.25
Nodes (7): /Users/rony/dev/worldcupPredictor/.opencode/gsd-core/*, permission, external_directory, read, plugin, /Users/rony/dev/worldcupPredictor/.opencode/gsd-core/*, $schema
...
Cohesion: 0.54
Nodes (8): sonnet, sonnet, sonnet, sonnet, sonnet, high, low, medium
...
Cohesion: 0.29
Nodes (7): parallelization, enabled, max_concurrent_agents, min_plans_for_parallel, plan_level, skip_checkpoints, task_level
...
Cohesion: 0.33
Nodes (5): Activation, Effect, Empty-answer handling, Question rendering, --text mode — plain-text overlay (no question)
...
Cohesion: 0.33
Nodes (6): gsd-advisor-researcher, balanced, budget, golden, phaseType, routingTier

### Community 248 - "Community 248"
Cohesion: 0.33
Nodes (6): gsd-ai-researcher, balanced, budget, golden, phaseType, routingTier

### Community 249 - "Community 249"
Cohesion: 0.33
Nodes (6): gsd-assumptions-analyzer, balanced, budget, golden, phaseType, routingTier

### Community 250 - "Community 250"
Cohesion: 0.33
Nodes (6): gsd-code-fixer, balanced, budget, golden, phaseType, routingTier

### Community 251 - "Community 251"
Cohesion: 0.33
Nodes (6): gsd-code-reviewer, balanced, budget, golden, phaseType, routingTier

### Community 252 - "Community 252"
Cohesion: 0.33
Nodes (6): gsd-codebase-mapper, balanced, budget, golden, phaseType, routingTier

### Community 253 - "Community 253"
Cohesion: 0.33
Nodes (6): gsd-debug-session-manager, balanced, budget, golden, phaseType, routingTier

### Community 254 - "Community 254"
Cohesion: 0.33
Nodes (6): gsd-debugger, balanced, budget, golden, phaseType, routingTier
...
Cohesion: 0.33
Nodes (6): gsd-doc-synthesizer, balanced, budget, golden, phaseType, routingTier

### Community 257 - "Community 257"
Cohesion: 0.33
Nodes (6): gsd-doc-verifier, balanced, budget, golden, phaseType, routingTier

### Community 258 - "Community 258"
Cohesion: 0.33
Nodes (6): gsd-doc-writer, balanced, budget, golden, phaseType, routingTier

### Community 259 - "Community 259"
Cohesion: 0.33
Nodes (6): gsd-domain-researcher, balanced, budget, golden, phaseType, routingTier

### Community 260 - "Community 260"
Cohesion: 0.33
Nodes (6): gsd-eval-auditor, balanced, budget, golden, phaseType, routingTier

### Community 261 - "Community 261"
Cohesion: 0.33
Nodes (6): gsd-eval-planner, balanced, budget, golden, phaseType, routingTier

### Community 262 - "Community 262"
Cohesion: 0.33
Nodes (6): gsd-executor, balanced, budget, golden, phaseType, routingTier

### Community 263 - "Community 263"
Cohesion: 0.33
Nodes (6): gsd-framework-selector, balanced, budget, golden, phaseType, routingTier

### Community 264 - "Community 264"
Cohesion: 0.33
Nodes (6): gsd-integration-checker, balanced, budget, golden, phaseType, routingTier

### Community 265 - "Community 265"
Cohesion: 0.33
Nodes (6): gsd-intel-updater, balanced, budget, golden, phaseType, routingTier

### Community 266 - "Community 266"
Cohesion: 0.33
Nodes (6): gsd-nyquist-auditor, balanced, budget, golden, phaseType, routingTier

### Community 267 - "Community 267"
Cohesion: 0.33
Nodes (6): gsd-pattern-mapper, balanced, budget, golden, phaseType, routingTier

### Community 268 - "Community 268"
Cohesion: 0.33
Nodes (6): gsd-phase-researcher, balanced, budget, golden, phaseType, routingTier

### Community 269 - "Community 269"
Cohesion: 0.33
Nodes (6): gsd-plan-checker, balanced, budget, golden, phaseType, routingTier

### Community 270 - "Community 270"
Cohesion: 0.33
Nodes (6): gsd-planner, balanced, budget, golden, phaseType, routingTier

### Community 271 - "Community 271"
Cohesion: 0.33
Nodes (6): gsd-project-researcher, balanced, budget, golden, phaseType, routingTier

### Community 272 - "Community 272"
Cohesion: 0.33
Nodes (6): gsd-research-synthesizer, balanced, budget, golden, phaseType, routingTier

### Community 273 - "Community 273"
Cohesion: 0.33
Nodes (6): gsd-roadmapper, balanced, budget, golden, phaseType, routingTier

### Community 274 - "Community 274"
Cohesion: 0.33
Nodes (6): gsd-security-auditor, balanced, budget, golden, phaseType, routingTier

### Community 275 - "Community 275"
Cohesion: 0.33
Nodes (6): gsd-ui-auditor, balanced, budget, golden, phaseType, routingTier

### Community 276 - "Community 276"
Cohesion: 0.33
Nodes (6): gsd-ui-checker, balanced, budget, golden, phaseType, routingTier

### Community 277 - "Community 277"
Cohesion: 0.33
Nodes (6): gsd-ui-researcher, balanced, budget, golden, phaseType, routingTier

### Community 278 - "Community 278"
Cohesion: 0.33
Nodes (6): gsd-user-profiler, balanced, budget, golden, phaseType, routingTier

### Community 279 - "Community 279"
Cohesion: 0.33
Nodes (6): gsd-verifier, balanced, budget, golden, phaseType, routingTier
...
Cohesion: 0.15
Nodes (12): 1. `packages/domain/src/db/schema.ts`, 2. `packages/data-providers/src/types.ts`, 3. `packages/data-providers/src/index.ts`, 4. `packages/data-providers/src/base-client.ts`, 5. `packages/data-providers/src/thestatsapi/client.ts`, 6. `packages/data-providers/src/thestatsapi/mapper.ts`, 7. `packages/data-providers/src/thestatsapi/fixtures.ts`, 8. `packages/data-providers/src/mock/mock-provider.ts` (+4 more)
...
Cohesion: 0.40
Nodes (5): planning, commit_docs, granularity, search_gitignored, sub_repos

### Community 306 - "Community 306"
Cohesion: 0.40
Nodes (4): _comment, dynamicKeyPatterns, runtimeStateKeys, validKeys
...
Cohesion: 0.50
Nodes (3): Capabilities, GSD Workflow Execution Skill, Workflow Execution Protocol
...
Cohesion: 0.50
Nodes (3): mode, timestamp, version
...
Cohesion: 0.50
Nodes (4): planning, commit_docs, search_gitignored, sub_repos
